  ...
  <div class="page">
    ...
    <div class="right-panel">
      <div class="form-container">
        ...
        <div class="oauth-row-single">
          <button class="oauth-btn google full-width" @click="handleGoogleLogin">
...
.oauth-row-single { display: flex; flex-direction: column; gap: 12px; }
...
.oauth-btn.full-width { width: 100%; }
